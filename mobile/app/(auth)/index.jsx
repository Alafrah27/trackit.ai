...
const onboardingPages = [
  {
    ...
    description:
      "Just speak and let AI track your expenses instantly without typing.",
    icon: "microphone",
  },
  {
    id: "2",
    ...
    description:
      "Your personal AI understands your commands and organizes everything for you.",
    icon: "robot-outline",
  },
  {
    id: "3",
    ...
    description:
      "Track everything in Arabic or English with powerful voice recognition.",
    icon: "translate",
  },
  {
    id: "4",
    ...
    description:
      "Get smart spending insights and never miss your important reminders.",
  ...
  },
  {
    ...
    description:
      "Manage expenses, reminders, and AI interactions in one powerful app.",
    ...
    <SafeAreaView className="flex-1 bg-surface">
      ...
      <View className="flex-row justify-end px-6 pt-4">
        <TouchableOpacity onPress={handleSkip}>
          <Text className="text-secondary font-semibold text-lg">Skip</Text>
        </TouchableOpacity>
      </View>
